...
const source = {
  ...
  events: [{ occurredAt: Date.UTC(2024, 4, 3), datePrecision: "day" as const, eventType: "memory", title: "第一個 # 作品", body: "保留了細節。", ageLabel: null, place: "台北", color: "#EE623B", isPublic: false, timelinePosition: 1, tags: [{ name: "學習", color: "#587A8B" }], media: [{ url: "https://example.test/image.jpg", fileName: "image.jpg", mimeType: "image/jpeg", caption: "一張照片", sortOrder: 0, storageKey: "secret-object-key" }] }],
