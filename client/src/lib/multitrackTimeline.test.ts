...
const events = [
  { id: 1, occurredAt: 100, title: "完成作品", color: "#EE623B", track: "career" as const, milestoneType: "highlight" as const, milestoneWeight: 5, skills: [{ id: 1, name: "Ableton Live" }] },
  { id: 2, occurredAt: 200, title: "學習工作流", color: "#587A8B", track: "skills" as const, milestoneType: "gear_workflow" as const, milestoneWeight: 3, skills: [{ id: 2, name: "Ableton Live" }, { id: 3, name: "色彩校準" }] },
  { id: 3, occurredAt: 300, title: "寫給未來", color: "#78976D", track: "life" as const, milestoneType: "reflection" as const, milestoneWeight: 2, skills: [], unlocksAt: 500 },
];
...
describe("multitrack timeline helpers", () => {
  ...
  it("keeps future capsules locked and reports meaningful milestone insight counts", () => {
    ...
    expect(getTimelineInsights(events)).toMatchObject({ eventCount: 3, projectCount: 1, highlightCount: 1, turningPointCount: 0, totalWeight: 10, leadingSkill: "Ableton Live" });
  });
});
