...
4. 私有資料一律最小化：預設 private，媒體不入資料庫，公開／link 範圍不得得到 private 事件、位置、語音、AI 或家庭欄位。AI、語音、GPS 地圖、媒體上傳與匯出需有使用者明確觸發或同意。全量 ZIP 還原只能由 owner 在本機驗證 checksum 後啟動，須保留 typed confirmation、staging 與單一交易提交；不得自動還原、跳過確認或恢復分享憑證。
