...
describe("diary router validation", () => {
  ...
  it("connects an owned event editing flow from creation through media ordering and sharing", async () => {
    ...
    const normalizedEvent = { ...event, skillNames: [], phaseKeywords: [], locationPrivacy: "none" as const, track: "life" as const, milestoneType: "standard" as const, milestoneWeight: 1 };
